...
const SECTION_META = {
  ...
  '/notebooks': {
    title: 'Notebooks — Study Hub & Knowledge Vault | BookmarkVault',
    description: 'Save, manage and organize your study notes and knowledge vault on BookmarkVault.',
  },
  '/codes': {
    title: 'Code Book — BookmarkVault',
    description: 'Store, organize and search code snippets with syntax highlighting on BookmarkVault.',
  },
  '/questions': {
    title: 'Questions & Problem Tracker — BookmarkVault',
    description: 'Practice and track problem-solving and interview questions on BookmarkVault.',
  },
  '/bookmarks': {
    title: 'Bookmarks Vault — BookmarkVault',
    description: 'Organize your web bookmarks, links and resources in one clean workspace.',
  },
  '/files': {
    title: 'Files & Cloud Vault — BookmarkVault',
    description: 'Upload, store and share your files safely with BookmarkVault.',
  },
  '/hisab': {
    title: 'Hisab & Expense Tracker — BookmarkVault',
    description: 'Track daily expenses, budgets, and transfers easily on BookmarkVault.',
  },
  '/routine': {
    title: 'Routine & Habit Tracker — BookmarkVault',
    description: 'Track your daily routine, habits, tasks, and productivity on BookmarkVault.',
  },
  '/chatbot': {
    title: 'AI Assistant Chat — BookmarkVault',
...
export async function onRequest(context) {
  ...
  if (contentType.includes('text/html')) {
    ...
    return new HTMLRewriter()
      ...
      .on('head', {
        element(e) {
          e.append(`<meta property="og:site_name" content="BookmarkVault">`, { html: true });
