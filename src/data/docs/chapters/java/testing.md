...
আগে ইন্টিগ্রেশন টেস্টে ইন-memory H2 ডাটাবেস ব্যবহার করা হতো, কিন্তু প্রোডাকশন PostgreSQL বা MySQL-এর ডায়ালেক্ট ও ফিচারের সাথে H2-এর অমিল থাকায় গোপন বাগ তৈরি হতো। আধুনিক জাভায় **Testcontainers** ডকার কন্টেইনারের মাধ্যমে রিয়েল ডাটাবেসে টেস্ট চালায়।
