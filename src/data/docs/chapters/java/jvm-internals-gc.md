...
## ২. Runtime Memory Model: Stack vs Heap
...
│ Stack সীমা ছাড়ালে: `StackOverflowError`│ Heap মেমোরি পূর্ণ হলে: `OutOfMemoryError` │
└────────────────────────────────────────┴────────────────────────────────────────┘
```
...
## ৪. Modern Garbage Collectors (G1GC vs ZGC)
