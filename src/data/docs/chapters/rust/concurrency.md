...
pub fn channel<T>() -> (Sender<T>, Receiver<T>) {
    let inner = Arc::new(Inner {
        queue: Queue::new(),  // message এখানে জমা হয়
        // receiver ঘুমচ্ছে কিনা + জাগানোর ব্যবস্থা এখানে
    });
...
// খেয়াল: 1 থেকে 10 লাখের যোগফল 500,000,500,000 — i32 এর সীমা
// (≈2.1 billion) পার করে যায়, তাই accumulator i64। i32 দিয়ে চালালে
// debug build এ "attempt to add with overflow" panic হতো।
...
fn main() {
    ...
    // Parallel — শুধু par_iter()! (accumulator i64 — 10 লাখের sum i32 পার করে যায়)
